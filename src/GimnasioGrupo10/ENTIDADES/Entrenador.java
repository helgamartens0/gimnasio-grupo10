...
public class Entrenador {
    ...
    public Entrenador(int id_entrenador, String dni_entrenador, String nombre_entrenador, String apellido_entrenador, String especialidad_entrenador, boolean estado_entrenador) {
    ...
    public Entrenador(String dni_entrenador, String nombre_entrenador, String apellido_entrenador, String especialidad_entrenador, boolean estado_entrenador) {
        this.dni_entrenador = dni_entrenador;
        this.nombre_entrenador = nombre_entrenador;
        this.apellido_entrenador = apellido_entrenador;
        this.especialidad_entrenador = especialidad_entrenador;
